...
?>
	<div id="dify-posts" data-page=0 data-show-hidden="<?php echo $show_hidden; ?>" data-source="plugin" data-install-name="<?php echo $site_info->name; ?>">
		<hr class="dify-section-break">
		<div id="dify-section-title">
		...
		<div>
			...
			<div class="show-more">
				<a href="#">Show More</a>
				<img id="dify-blog-spinner" src="<?php echo WPE_PLUGIN_URL; ?>/images/ajax-loader-transparent.gif"/ >
			</div>
		</div>
	</div><!-- .dify-posts .panel .panel-widget -->
<?php } /* is_wpe_snapshot() */ ?>
</div><!--.wrap-->
